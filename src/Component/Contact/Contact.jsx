...
const Contact = () => {
  return (
    <>
    {/* Banner section  */}
    <div className="container-fluid bg-breadcrumb" style={{...aboutBackImg}}>
    ...
    <div className="container-fluid contact py-5">
      <div className="container py-5">
        ...
        >
          ...
          <p className="mb-0 tw-text-justify">
           Lorem ipsum, dolor sit amet consectetur adipisicing elit. A vitae nemo dolor dolorum! Quasi repellat sapiente iste amet deserunt? Dicta beatae molestias voluptas vel. Ea repudiandae iure laborum voluptatem dicta!
          </p>
        </div>
            ...
            <div className="row g-5">
              <div className="col-md-6 col-lg-6 col-xl-3">
                <div className="contact-add-item p-4">
                  ...
                  <div>
                    <h4>Address</h4>
                    <p className="mb-0">Opposite Bank of Baroda, Ward Number 3, Parsodi, Trimurtee Nagar, Nagpur, Maharashtra 440022</p>
                  </div>
                </div>
              </div>
              <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                <div className="contact-add-item p-4">
                  ...
                  <div>
                    <h4>Mail Us</h4>
                    <p className="mb-0">sales@elioratechnologies.com</p>
                  </div>
                </div>
              </div>
